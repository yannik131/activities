...
def friendship_saved(instance: Friendship, created, **kwargs):
    if created:
        create_action(instance.from_user, _('ist jetzt befreundet mit'), instance.to_user)
...
def friendship_destroyed(instance: Friendship, **kwargs):
    create_action(instance.from_user, _('ist nicht mehr befreundet mit'), instance.to_user)
